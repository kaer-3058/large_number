...
#开始信号：scoreboard players set #int.composite_simpson-s_rule_info int 1
#需要tick执行：function large_number:definite_integral/composite_simpson-s_rule/different_steps/tick

execute unless score #large_number.all_tellraw_set int matches 1 run tellraw @a {"translate":"large_number.definite_integral.start","fallback": "\u00A77\u00A7o定积分开始计算"}
...
#循环
scoreboard players set #int.composite_simpson-s_rule_diff.loop1 int 1
scoreboard players set #int.composite_simpson-s_rule_info int 2
