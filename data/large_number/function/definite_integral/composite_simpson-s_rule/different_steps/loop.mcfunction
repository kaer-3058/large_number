...
execute store result storage large_number:math temp3 int 1 run scoreboard players get #int.composite_simpson-s_rule_diff.loop1 int
...
#循环
scoreboard players add #int.composite_simpson-s_rule_diff.loop1 int 1
scoreboard players add #temp_int.composite_simpson-s_rule_diff.loop1 int 1
execute if score #int.composite_simpson-s_rule_diff.loop1 int <= #int.composite_simpson-s_rule.n int if score #temp_int.composite_simpson-s_rule_diff.loop1 int < #definite_integral.loops int run function large_number:definite_integral/composite_simpson-s_rule/different_steps/loop
