...
#开始信号：scoreboard players set ##definite_integral.different_steps.start int 1
#需要tick执行：function large_number:definite_integral/riemann_integral/different_steps/tick
...
scoreboard players set ##definite_integral.different_steps.start int 2
