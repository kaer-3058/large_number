...
data modify storage large_number:math temp1 set from storage large_number:math expression_evaluation.definite_integral.a
...
execute unless score #Store_expression_evaluation.definite_integral.loop int > #Store_expression_evaluation.definite_integral.dx_times int if score #temp_definite_integral.loops int < #definite_integral.loops int run function large_number:definite_integral/riemann_integral/different_steps/loop
