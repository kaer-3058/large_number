...
execute store result storage large_number:math temp1 int 1 run data get storage large_number:math display_div_large.input.dividend1[0]
...
execute store result storage large_number:math temp4 int 1 run data get storage large_number:math display_div_large.input.dividend2[0]
...
execute store result storage large_number:math temp7 int 1 run data get storage large_number:math display_div_large.input.dividend3[0]
...
execute store result storage large_number:math temp10 int 1 run data get storage large_number:math display_div_large.input.divisor[0]
...
data modify storage large_number:math temp2 set value [0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f,0f]
data modify storage large_number:math temp2[0] set from storage large_number:math temp1[0]
data modify storage large_number:math temp2[5] set from storage large_number:math temp1[1]
data modify storage large_number:math temp2[10] set from storage large_number:math temp1[2]
data modify storage large_number:math temp2[15] set from storage large_number:math temp1[3]
data modify entity 28529-0-3d00-0-2c4200ee8401 transformation set from storage large_number:math temp2
