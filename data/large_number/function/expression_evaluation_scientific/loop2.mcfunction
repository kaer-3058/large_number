...
execute unless score #temp1 int matches 13 unless data storage large_number:math {sstemp2:""} run function large_number:expression_evaluation_scientific/loop2
