...
data modify storage large_number:math temp_expression_sign set value ["+","-","*","/","^","exp","log","sin","cos","arcsin","arccos","ln","√","Γ","┕","ºLambertW","¹LambertW","||","sgn","[]","—","atan","ψ","Σ[1/n]n→","eunorm₂","eunorm₃","²","·","arctan","[0]",">=","<=","==","≈≈",">/<",">-<",">>","<<","≥≥","≤≤","nroot","ºsinh","ºcosh","ºtanh"]
data modify storage large_number:math stemp_expression1 set from storage large_number:math temp_expression_s2[0]
scoreboard players set #temp1 int 44
...
execute if score #temp1 int matches 44 run function large_number:expression_evaluation_scientific/ope_of_float/loop1.if
execute unless score #temp1 int matches 44 run function large_number:expression_evaluation_scientific/ope_of_float/ope
