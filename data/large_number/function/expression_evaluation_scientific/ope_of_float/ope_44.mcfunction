...
data modify storage large_number:math tan_high_precision.input set from storage large_number:math temp2
function large_number:math_trifs/tan_high_precision/start
data modify storage large_number:math _expressionss3 set from storage large_number:math tan_high_precision.output
