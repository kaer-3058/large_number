...
execute if score #temp_float_base_int_power_temp1 int matches 2.. run function large_number:float_base_int_power/fast_power/2
execute if data storage large_number:math temp_convert_deci run data modify storage large_number:math float_base_int_power.output set from storage large_number:math temp_convert_deci[0].c
