function large_number:float_add_subtra/macro1 with storage large_number:math
...
execute if score #temp_test.float_add_sub.number_is_large int matches 0 as b09e-44-fded-6-efa5ffffef64 run function large_number:float_comparison_sizes/float_subra_small.1 with storage large_number:math
execute if score #temp_test.float_add_sub.number_is_large int matches 1 run function large_number:float_comparison_sizes/float_subra_large.1 with storage large_number:math
