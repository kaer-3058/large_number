...
execute if score #float_int0 int matches 100000000.. if score #_exp int matches -152..-1 store result score #float_int0 int run function large_number:float_nbt_to_score/tree/1-16
...
execute if score #float_int0 int matches ..9999999 if score #_exp int matches -308..-153 store result score #float_int0 int run function large_number:float_nbt_to_score/tree/_1/17-33
