...
data modify storage large_number:math temp_b15 set string storage large_number:math float_division.output 0 -1


execute if score #temp_fourier_series_numerical.items int <= #temp_fourier_series_numerical.items.max int run function large_number:fourier_series_numerical/different_steps/test
