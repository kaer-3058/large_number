...
data modify storage large_number:math temp_a7 set string storage large_number:math float_division.output 0 -1

#B3
data modify storage large_number:math fourier_series_numerical.abnum set value "B7"
function large_number:fourier_series_numerical/different_steps/item_7/b2.macro with storage large_number:math
