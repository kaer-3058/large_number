...
execute if score #fourier_series_numerical.tell_mode int matches 1..2 run tellraw @a {"translate":"large_number.fourier_series_numerical.start","fallback": "\u00A77\u00A7o傅里叶级数开始计算"}
