...
#输入：data modify storage large_number:math stemp_gamma_function_inp set value 71.0d

#载入除数
data modify storage large_number:math float_nbt_to_score_input set from storage large_number:math stemp_gamma_function_inp
...
scoreboard players set #float_int0 int 628318531
