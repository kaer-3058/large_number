...
# 1234 5679 0123 4567 9012
execute store result score #E int store result score #z int store result score #5 int run scoreboard players set #e int 9012
execute store result score #D int store result score #y int store result score #4 int run scoreboard players set #d int 4567
execute store result score #C int store result score #x int store result score #3 int run scoreboard players set #c int 123
execute store result score #B int store result score #v int store result score #2 int run scoreboard players set #b int 5679
execute store result score #A int store result score #u int store result score #1 int run scoreboard players set #a int 1234
...
execute store result storage large_number:math sstemp2 int 1 run scoreboard players remove #float_mul.high_precision.input1.expon int 22
