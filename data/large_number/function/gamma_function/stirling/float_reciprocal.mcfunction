...
#输入：data modify storage large_number:math gamma_function.input set value 71.0d

#载入除数
data modify storage large_number:math float_nbt_to_score_input set from storage large_number:math gamma_function.input
...
scoreboard players set #float_int0 int 845072303
