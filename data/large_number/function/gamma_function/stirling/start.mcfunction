...
execute if score #1.expression_evaluation_test1 int matches 0 run function large_number:gamma_function/stirling/if/1
execute if score #1.expression_evaluation_test1 int matches 1 run function large_number:gamma_function/stirling/if/2
