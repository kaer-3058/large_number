...
execute rotated ~ .0 positioned .0 .0 .0 as b09e-44-fded-6-efa5ffffef64 run function large_number:geometry/conical_selection_area/fan-shaped/1
function large_number:geometry/conical_selection_area/fan-shaped/macro1 with storage large_number:math conical_selection_area
