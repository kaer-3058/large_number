...
execute store result score #sstemp1 int run data get storage large_number:math stemp3[0]
execute store result score #sstemp2 int run data get storage large_number:math stemp3[1]
data remove storage large_number:math stemp3[0]
data remove storage large_number:math stemp3[0]
...
data modify storage large_number:math stemp3 prepend from storage large_number:math tempc
data modify storage large_number:math stemp3 prepend from storage large_number:math tempb
data modify storage large_number:math stemp3 prepend from storage large_number:math tempa
