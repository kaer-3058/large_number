...
execute store result score #t1 int store result score #t2 int store result score #t3 int run scoreboard players operation output.sqrt int = input.sqrt int
...
scoreboard players operation output.sqrt int /= 2 const
scoreboard players operation input.sqrt int /= output.sqrt int
execute if score output.sqrt int > input.sqrt int run scoreboard players remove output.sqrt int 1
