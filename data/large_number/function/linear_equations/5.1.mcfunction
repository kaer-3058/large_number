data modify storage large_number:math temp_output_matrix set value [[],[0d],[0d,0d],[0d,0d,0d],[0d,0d,0d]]

function large_number:linear_equations/5.2
...
data modify storage large_number:math temp_output_matrix[4] append from storage large_number:math store_det_input[1][]
