...
data modify storage large_number:math stemp1 set from storage large_number:math list_ope_random_index_once.input
execute store result storage large_number:math temp1 int 1 run data get storage large_number:math stemp1
...
data modify storage large_number:math list_ope_random_index_once.input set from storage large_number:math stemp1
