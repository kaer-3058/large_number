...
execute if data storage large_number:math stemp0[1] run function large_number:list_operation/sort/int_descending_order/loop2
...
execute if data storage large_number:math stemp0[1] if score #temp_sorting int matches 1 run function large_number:list_operation/sort/int_descending_order/loop
