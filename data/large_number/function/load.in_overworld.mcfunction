...
setblock -29999984 -60 22022222 minecraft:command_block[facing=up]{Command:'execute if score #cb_run_func:"timestamp/cb_start" int matches 1 if data block -29999982 -60 22022222 profile.properties[0].value run function large_number:timestamp/cb_start',UpdateLastExecution:1b,TrackOutput:1b,CustomName:'{"text":"large_number.timestamp"}'}
