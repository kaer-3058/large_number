...
execute if score #loops lan.pi_information <= #length lan.pi_information unless score #pi.block2.times lan.pi_information matches 2711.. run scoreboard players set #if lan.pi_information 1

execute if score #if lan.pi_information matches 1 run scoreboard players set #pi.different_steps.mode lan.pi_information 6
