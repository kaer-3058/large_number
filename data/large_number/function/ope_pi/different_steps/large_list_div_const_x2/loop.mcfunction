...
execute store result storage large_number:pi_information temp int 1 run scoreboard players operation #temp3 lan.pi_information /= 57121 const
data modify storage large_number:pi_information sstemp2 append from storage large_number:pi_information temp
scoreboard players operation #temp1 lan.pi_information %= 57121 const
