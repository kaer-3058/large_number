execute store result score #temp1 lan.pi_information store result score #temp2 lan.pi_information run data get storage large_number:pi_information sstemp2[0]
...
data modify storage large_number:pi_information sstemp3 prepend from storage large_number:pi_information stemp1
