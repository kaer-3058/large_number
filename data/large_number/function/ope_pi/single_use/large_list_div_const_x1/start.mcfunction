...
execute if data storage large_number:pi_information sstemp1[0] run function large_number:ope_pi/single_use/large_list_div_const_x1/loop

#去掉前导0
execute store result score #temp1 lan.pi_information run data get storage large_number:pi_information sstemp2[0]
execute if score #temp1 lan.pi_information matches 0 if data storage large_number:pi_information sstemp2[1] run function large_number:ope_pi/single_use/large_list_div_const_x1/del_leading_zeros
