...
#除法，除以常数
function large_number:ope_pi/single_use/large_list_div_const_x1/start
function large_number:ope_pi/single_use/large_list_div_const_x2/start
...
function large_number:ope_pi/single_use/large_list_div_const/start
...
execute if score #loops lan.pi_information <= #length lan.pi_information run function large_number:ope_pi/single_use/loop_each_item
