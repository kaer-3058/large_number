...
execute if score #temp_if_j lan.pi_information matches 1 run function large_number:ope_pi/single_use/loop_sum_if/subra
execute if score #temp_if_j lan.pi_information matches 0 run function large_number:ope_pi/single_use/loop_sum_if/addi
...
execute if score #temp1 lan.pi_information matches 0 if data storage large_number:pi_information temp9[1] run function large_number:ope_pi/single_use/loop_sum_if/del_leading_zeros
