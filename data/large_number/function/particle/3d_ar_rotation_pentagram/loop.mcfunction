...
execute store result storage large_number:math temp1[0] double .001 run scoreboard players operation #temp0 int /= 1000 const

#y
scoreboard players operation #temp1 int = #tempv int
scoreboard players operation #temp1 int *= #tempj1 int
execute store result storage large_number:math temp1[2] double .001 run scoreboard players operation #temp1 int /= 1000 const
...
execute if score #sstemp1 int matches 0 run data modify storage large_number:math 3d_ar_rotation_pentagram_pos append from storage large_number:math temp1
execute if score #sstemp1 int matches 0 run data remove storage large_number:math 3d_ar_rotation_pentagram_pos[-1][1]
