...
function large_number:particle/archimedean_spiral/particle.macro1 with storage large_number:math

data remove storage large_number:math temp1[0]
data remove storage large_number:math temp2[0]
execute if data storage large_number:math temp1[0] run function large_number:particle/archimedean_spiral/particle_loop
