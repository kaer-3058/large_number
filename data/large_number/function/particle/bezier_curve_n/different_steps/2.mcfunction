...
execute unless score #large_number.all_tellraw_set int matches 1 if score #bezier_curve_N.t int matches 10001.. run tellraw @a {"translate":"large_number.bezier_curve_n.end","fallback":"\u00A77\u00A7oN阶贝塞尔曲线求解完成"}
