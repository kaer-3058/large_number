...
scoreboard players add #Store_bezier_curve_n.diff_loops int 1
execute unless score #bezier_curve_N.t int matches 10001.. if score #Store_bezier_curve_n.diff_loops int < #bezier_curve_n.diff_loops int run function large_number:particle/bezier_curve_n/different_steps/loop3
