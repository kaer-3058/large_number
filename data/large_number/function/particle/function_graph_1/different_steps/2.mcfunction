...
execute unless score #large_number.all_tellraw_set int matches 1 if score #loop1 int > #function_graph_1.b int run tellraw @a {"translate":"large_number.function_graph_1.diff_end","fallback":"\u00A77\u00A7o一元函数图像绘制完成"}
