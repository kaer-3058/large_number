...
scoreboard players add #temp_function_graph_2.loops int 1
scoreboard players operation #function_graph_2_Pos.loop1 int += #function_graph_2.step int
execute unless score #function_graph_2_Pos.loop1 int > #function_graph_2.x_max int if score #temp_function_graph_2.loops int < #function_graph_2.loops int run function large_number:particle/function_graph_2/different_steps2/loop2
