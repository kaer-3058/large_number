...
execute unless score #large_number.all_tellraw_set int matches 1 run tellraw @a {"translate":"large_number.holographic_projection.end","fallback":"\u00A77\u00A7o全息粒子投影：扫描完成！"}
