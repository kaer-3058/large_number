...
execute as b09e-44-fded-6-efa5ffffef64 run function large_number:particle/lightning_bolt_instant/unit_vector_for_distance_modu
...
execute if score #distance int > #lightning_bolt.a_segment int run function large_number:particle/lightning_bolt_instant/1/start
execute unless score #distance int > #lightning_bolt.a_segment int run function large_number:particle/lightning_bolt_instant/loop.unless
execute if data storage large_number:math temp_lnb_points[1] run function large_number:particle/lightning_bolt_instant/loop
