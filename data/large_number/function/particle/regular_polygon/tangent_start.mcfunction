...
execute store result score #sstemp2 int store result score #sstemp1 int run scoreboard players operation #temp_θ int /= #regular_polygon.n int
...
data modify storage large_number:math temp6 set from entity @s Pos[0]

#计算外切多边形的半径
execute store result entity @s Rotation[0] float .0001 run scoreboard players operation #sstemp2 int /= 2 const
execute rotated as @s rotated ~ .0 positioned .0 .0 .0 run tp @s ^1.0 ^ ^ ~ ~
execute store result score #temp2 int run data get entity @s Pos[0] 1000
execute store result score #temp3 int run scoreboard players operation #tangent_regular_polygon.r int = #regular_polygon.r int
scoreboard players operation #tangent_regular_polygon.r int /= #temp2 int
scoreboard players operation #temp3 int %= #temp2 int
scoreboard players operation #temp3 int *= 1000 const
scoreboard players operation #temp3 int /= #temp2 int
scoreboard players operation #tangent_regular_polygon.r int *= 1000 const
execute store result storage large_number:math temp_r double .001 store result score #sstemp3 int run scoreboard players operation #tangent_regular_polygon.r int += #temp3 int

scoreboard players operation #sstemp3 int *= 2 const
data modify storage large_number:math temp1 set string storage large_number:math temp6 0 -1
