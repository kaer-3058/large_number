...
execute store result storage large_number:math temp1 int 1 run scoreboard players operation #inp int = #X_squ_equ.delta int
...
execute store result storage large_number:math temp2 int 1 run scoreboard players operation #stemp2 int *= -1 const
execute store result storage large_number:math temp3 int 1 run scoreboard players operation #stemp1 int *= 2 const
execute if score #stemp2 int matches 0 run data modify storage large_number:math temp2 set value ""

# delta：#X_squ_equ.delta，-b：#stemp2 int，2a：#stemp1 int

function large_number:quadratic_equation/roots.2.expression with storage large_number:math
...
data modify storage large_number:math quadratic_equation_out.double set value [0.0d,0.0d]
execute store result storage large_number:math quadratic_equation_out.double[0] double 0.0001 store result score #X_squ_equ.x1 int run scoreboard players operation #stemp2 int /= #stemp1 int
execute store result storage large_number:math quadratic_equation_out.double[1] double 0.0001 store result score #X_squ_equ.x2 int run scoreboard players operation #stemp200 int /= #stemp1 int
