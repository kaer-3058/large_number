...
execute unless data storage large_number:math {temp_a:0.0} unless data storage large_number:math {temp_delta_sign:"-"} unless data storage large_number:math {temp_delta:0.0} run function large_number:quadratic_equation_double/roots.2
