...
execute unless score #stemp1 int matches 0 unless score #stemp1 int matches ..-1 unless score #stemp2 int matches ..-1 run function large_number:sqrt_continued_fraction/loop.reduction_fraction
