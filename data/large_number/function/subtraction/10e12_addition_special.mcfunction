...
execute store result storage large_number:math subtraction.output[0] int 1.0 run scoreboard players get #4.1 int
execute store result storage large_number:math subtraction.output[1] int 1.0 run scoreboard players get #1.1 int
