...
#被减数
execute store result score #1.4 int run data get storage large_number:math subtraction.input1[3]
execute store result score #1.3 int run data get storage large_number:math subtraction.input1[2]
execute store result score #1.2 int run data get storage large_number:math subtraction.input1[1]
execute store result score #1.1 int run data get storage large_number:math subtraction.input1[0]

#减数
execute store result score #2.4 int run data get storage large_number:math subtraction.input2[3]
execute store result score #2.3 int run data get storage large_number:math subtraction.input2[2]
execute store result score #2.2 int run data get storage large_number:math subtraction.input2[1]
execute store result score #2.1 int run data get storage large_number:math subtraction.input2[0]
