...
execute store result score #u int run data get storage large_number:math temp1[0] 10000
execute store result score #i.y int run data get storage large_number:math temp1[1] 10000
execute store result score #i.z int run data get storage large_number:math temp1[2] 10000
...
execute positioned .0 .0 .0 run tp @s ^ ^1 ^
data modify storage large_number:math temp1 set from entity @s Pos
execute store result score #v int run data get storage large_number:math temp1[0] 10000
...
execute positioned .0 .0 .0 run tp @s ^ ^ ^1
data modify storage large_number:math temp1 set from entity @s Pos
execute store result score #w int run data get storage large_number:math temp1[0] 10000
