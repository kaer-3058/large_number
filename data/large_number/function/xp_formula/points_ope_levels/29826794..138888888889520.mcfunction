##根据输入的经验总数求经验等级和经验余数
#反向经验公式：[√(72x-55503) +325] / 18 (x≥1758)
...
#减法 -55503
execute if score #xp_2.input[4] int matches ..5502 run scoreboard players remove #xp_2.input[3] int 1
execute if score #xp_2.input[4] int matches ..5502 run scoreboard players add #xp_2.input[4] int 10000
...
execute store result storage large_number:math large_sqrt_digit16.input[2] int 1 run scoreboard players get #xp_2.input[3] int
execute store result storage large_number:math large_sqrt_digit16.input[3] int 1 run scoreboard players get #xp_2.input[4] int
...
data modify storage large_number:math large_sqrt_digit16 set from storage large_number:math store_large_sqrt_digit16
