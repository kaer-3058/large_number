...
#反向经验公式：[√(72x-54215) +307] / 18 (x≥1628)
...
# 352..1627
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 0 if score #storeT_xp_2.input[4] int matches 352..1627 store result storage large_number:math xp_points_ope_levels.output_levels int 1 run function large_number:xp_formula/points_ope_levels/352..1627

scoreboard players set #mode int 0

# 1628..2982,6913
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 0 if score #storeT_xp_2.input[4] int matches 1628.. run scoreboard players set #mode int 1
...
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 2982 if score #storeT_xp_2.input[4] int matches ..6913 run scoreboard players set #mode int 1

# 2982,6914..138,8888,8888,9520
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 2982 if score #storeT_xp_2.input[4] int matches 6914.. run scoreboard players set #mode int 2
...
execute if score #mode int matches 1 run function large_number:xp_formula/points_ope_levels/1628..29826793
