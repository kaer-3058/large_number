...
#data modify storage math 1we_multiply.input1 set value [I;9999,9999,9999]
#data modify storage math 1we_multiply.input2 set value [I;9999,9999,9999]

execute store result score #x int run data get storage math 1we_multiply.input1[0]
execute store result score #y int run data get storage math 1we_multiply.input1[1]
execute store result score #z int run data get storage math 1we_multiply.input1[2]

execute store result score #a int run data get storage math 1we_multiply.input2[0]
execute store result score #b int run data get storage math 1we_multiply.input2[1]
execute store result score #c int run data get storage math 1we_multiply.input2[2]
...
#调整符号
execute unless score #input_-1 int = #input.2_-1 int run function large_number:multiply_unlessinput_-1iinput.2_-1_2

data modify storage math 1we_multiply.output set value [I;0,0,0,0,0,0]
execute store result storage math 1we_multiply.output[0] int 1.0 run scoreboard players get #4.0 int
execute store result storage math 1we_multiply.output[1] int 1.0 run scoreboard players get #4.1 int
execute store result storage math 1we_multiply.output[2] int 1.0 run scoreboard players get #4.2 int
execute store result storage math 1we_multiply.output[3] int 1.0 run scoreboard players get #4.3 int
execute store result storage math 1we_multiply.output[4] int 1.0 run scoreboard players get #4.4 int
execute store result storage math 1we_multiply.output[5] int 1.0 run scoreboard players get #4.5 int
