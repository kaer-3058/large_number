...
execute store result score #c int run data get storage math 1we_squ.input[2]
execute store result score #b int run data get storage math 1we_squ.input[1]
execute store result score #a int run data get storage math 1we_squ.input[0]
...
data modify storage math 1we_squ.output set value [I;0,0,0,0,0,0]
execute store result storage math 1we_squ.output[0] int 1.0 run scoreboard players operation #5.0 int /= 10000 const
execute store result storage math 1we_squ.output[1] int 1.0 run scoreboard players operation #4.1 int %= 10000 const
execute store result storage math 1we_squ.output[2] int 1.0 run scoreboard players operation #4.2 int %= 10000 const
execute store result storage math 1we_squ.output[3] int 1.0 run scoreboard players operation #4.3 int %= 10000 const
execute store result storage math 1we_squ.output[4] int 1.0 run scoreboard players operation #4.4 int %= 10000 const
execute store result storage math 1we_squ.output[5] int 1.0 run scoreboard players operation #4.5 int %= 10000 const
