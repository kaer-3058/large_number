...
data modify storage math addition.output set value [I;0,0,0,0]
...
#输出
execute store result storage math addition.output[0] int 1.0 run scoreboard players get #4.1 int
execute store result storage math addition.output[1] int 1.0 run scoreboard players get #1.1 int
execute store result storage math addition.output[2] int 1.0 run scoreboard players get #1.2 int
execute store result storage math addition.output[3] int 1.0 run scoreboard players get #1.3 int
