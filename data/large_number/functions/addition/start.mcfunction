...
#获取数字
execute store result score #1.3 int run data get storage large_number:math addition.input1[2]
execute store result score #1.2 int run data get storage large_number:math addition.input1[1]
execute store result score #1.1 int run data get storage large_number:math addition.input1[0]

execute store result score #2.3 int run data get storage large_number:math addition.input2[2]
execute store result score #2.2 int run data get storage large_number:math addition.input2[1]
execute store result score #2.1 int run data get storage large_number:math addition.input2[0]
