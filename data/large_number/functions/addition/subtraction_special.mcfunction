...
execute store success storage large_number:math addition.output[0] int 0.0 store result storage large_number:math addition.output[1] int 1.0 run scoreboard players get #1.1 int
