...
execute store result storage large_number:math temp1 int 1 run scoreboard players operation #cbrt.output int += #x int

execute if score #temp2 int matches 1..9 store result storage large_number:math temp1 int 0.002154434690032 run scoreboard players get #cbrt.output int
execute if score #temp2 int matches 10..999 store result storage large_number:math temp1 int 0.01 run scoreboard players get #cbrt.output int
execute if score #temp2 int matches 1000..99999 store result storage large_number:math temp1 int 0.0464158883361 run scoreboard players get #cbrt.output int
execute if score #temp2 int matches 100000..9999999 store result storage large_number:math temp1 int 0.2154434690032 run scoreboard players get #cbrt.output int

execute store result score #cbrt.output int run data get storage large_number:math temp1
