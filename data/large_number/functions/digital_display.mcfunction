...
#清除整个数组的前导0
execute if score #4.0 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 7 if score #4.1 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 6 if score #temp1 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 5 if score #temp2 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 4 if score #temp3 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 3 if score #temp4 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 2 if score #temp5 int matches 1000 run data remove storage large_number:math buffer_digital_display_json[0]
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 1 if score #temp6 int matches 1000 run data modify storage large_number:math buffer_digital_display_json set value ["0"]

data modify storage large_number:math temp1 set string storage large_number:math buffer_digital_display_json[0] 0 2
execute if data storage large_number:math {temp1:"00"} run data modify storage large_number:math buffer_digital_display_json[0] set string storage large_number:math buffer_digital_display_json[0] 2
data modify storage large_number:math temp1 set string storage large_number:math buffer_digital_display_json[0] 0 1
execute if data storage large_number:math {temp1:"0"} run data modify storage large_number:math buffer_digital_display_json[0] set string storage large_number:math buffer_digital_display_json[0] 1
execute store result score #stemp9 int run data get storage large_number:math buffer_digital_display_json
execute if score #stemp9 int matches 1 if data storage large_number:math {buffer_digital_display_json:[""]} run data modify storage large_number:math buffer_digital_display_json set value ["0"]
