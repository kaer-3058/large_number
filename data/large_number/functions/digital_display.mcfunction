...
#自适应0~24位数
data modify storage math temp_math_display set from storage math math_display
execute store result score #list_maths int if data storage math temp_math_display[]
execute if score #list_maths int matches ..5 run data modify storage math temp_math_display prepend value 0
execute if score #list_maths int matches ..4 run data modify storage math temp_math_display prepend value 0
execute if score #list_maths int matches ..3 run data modify storage math temp_math_display prepend value 0
execute if score #list_maths int matches ..2 run data modify storage math temp_math_display prepend value 0
execute if score #list_maths int matches ..1 run data modify storage math temp_math_display prepend value 0
execute if score #list_maths int matches 0 run data modify storage math temp_math_display prepend value 0

#取数
execute store result score #temp1 int run data get storage math temp_math_display[0]
execute store result score #temp2 int run data get storage math temp_math_display[1]
execute store result score #temp3 int run data get storage math temp_math_display[2]
execute store result score #temp4 int run data get storage math temp_math_display[3]
execute store result score #temp5 int run data get storage math temp_math_display[4]
execute store result score #temp6 int run data get storage math temp_math_display[5]
