...
execute store result score #Divisor_float_int0 int run data get storage math temp1
...
execute if score #temp1 int matches 0 if data storage math {stemp2:"0.0"} run scoreboard players set #leading_zero int 2
execute if score #temp1 int matches 0 if data storage math {stemp1:"0.00"} run scoreboard players set #leading_zero int 3
execute if score #leading_zero int matches 3 store result score #Divisor_float_int0 int run data get storage math temp1 10000000000
execute if score #leading_zero int matches 3 run scoreboard players remove #Divisor_float_exp int 2
execute if score #leading_zero int matches 2 store result score #Divisor_float_int0 int run data get storage math temp1 1000000000
execute if score #leading_zero int matches 2 run scoreboard players remove #Divisor_float_exp int 1
execute if score #leading_zero int matches 1 store result score #Divisor_float_int0 int run data get storage math temp1 100000000
execute if score #temp1 int matches 1..9 store result score #Divisor_float_int0 int run data get storage math temp1 10000000
execute if score #temp1 int matches 1..9 run scoreboard players add #Divisor_float_exp int 1
execute if score #temp1 int matches 10..99 store result score #Divisor_float_int0 int run data get storage math temp1 1000000
execute if score #temp1 int matches 10..99 run scoreboard players add #Divisor_float_exp int 2
execute if score #temp1 int matches 100..999 store result score #Divisor_float_int0 int run data get storage math temp1 100000
execute if score #temp1 int matches 100..999 run scoreboard players add #Divisor_float_exp int 3
execute if score #temp1 int matches 1000..9999 store result score #Divisor_float_int0 int run data get storage math temp1 10000
execute if score #temp1 int matches 1000..9999 run scoreboard players add #Divisor_float_exp int 4
execute if score #temp1 int matches 10000..99999 store result score #Divisor_float_int0 int run data get storage math temp1 1000
execute if score #temp1 int matches 10000..99999 run scoreboard players add #Divisor_float_exp int 5
execute if score #temp1 int matches 100000..999999 store result score #Divisor_float_int0 int run data get storage math temp1 100
execute if score #temp1 int matches 100000..999999 run scoreboard players add #Divisor_float_exp int 6
execute if score #temp1 int matches 1000000.. store result score #Divisor_float_int0 int run data get storage math temp1 10
...
execute store result storage math temp4 int 1 run scoreboard players add #float_int1 int 10000
data modify storage math temp4 set string storage math temp4 1
function large_number:division/float_12dicimal/macro2 with storage math
