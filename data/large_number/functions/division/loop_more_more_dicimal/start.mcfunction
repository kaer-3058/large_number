...
data modify storage math loop_more_more_dicimal_base set value []
...
execute store result storage math temp1 int 1 run scoreboard players operation #stemp1 int /= #Divisor_float_int0 int
data modify storage math loop_more_more_dicimal_base append from storage math temp1
