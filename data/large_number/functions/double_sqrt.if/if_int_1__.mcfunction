...
execute if score #temp2 int matches 0..9 store result storage math double_sqrt.output.double double 0.0000001 run scoreboard players get #d2.1 int
execute if score #temp2 int matches 10..99 store result storage math double_sqrt.output.double double 0.000001 run scoreboard players get #d2.1 int
execute if score #temp2 int matches 100..999 store result storage math double_sqrt.output.double double 0.00001 run scoreboard players get #d2.1 int
execute if score #temp2 int matches 1000..9999 store result storage math double_sqrt.output.double double 0.0001 run scoreboard players get #d2.1 int
