execute store result score #1.0 int store result score #1.1 int store result score #1.2 int store result score #1.3 int store result score #d2.1 int run scoreboard players operation #d1.1 int = #ds1.0 int
