execute store result storage math temp1 int 3.162277660168 run scoreboard players get #d2.1 int
execute store result score #d2.1 int run data get storage math temp1
