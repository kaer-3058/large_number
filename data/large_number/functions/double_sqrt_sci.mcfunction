...
execute store result score #ds1.1 int store result score #ds1.0 int run data get storage large_number:math double_sqrt.input
...
#如果是科学记数法，则取数值部分的整数
execute if score #is_XXEXX int matches 1 store result score #ds1.1 int store result score #ds1.0 int run data get storage large_number:math temp_string_list[0].a
...
data modify storage large_number:math double_sqrt.output set value {int:0,double:0.0d,expon:0s}
execute store result storage large_number:math double_sqrt.output.int int 1.0 run scoreboard players get #d2.1 int
execute if score #is_XXEXX int matches 1 store result storage large_number:math double_sqrt.output.expon short 1.0 run scoreboard players get #double_to_int.expon.1 int
...
execute if data storage large_number:math double_sqrt{input:0.0d} store result storage large_number:math double_sqrt.output.int int 0 store result storage large_number:math double_sqrt.output.double double 0 run data modify storage large_number:math double_sqrt.output.expon set value 0s
