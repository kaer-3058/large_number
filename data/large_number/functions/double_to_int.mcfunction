...
data modify storage math double_to_int.output set value {math:[I;0,0,0,0],sign:1b,point:0b,leading_zeros:0b}
...
#测试数字是否为0
execute if data storage math double_to_int{input:0.0d} store success storage math double_to_int.output.point byte 0 store success storage math double_to_int.output.leading_zeros byte 0 run data modify storage math double_to_int.output.sign set value 0b
