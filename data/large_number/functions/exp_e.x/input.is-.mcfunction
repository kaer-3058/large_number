...
data modify storage math float_reciprocal.input set from storage math temp1
...
data modify storage math exp_e^x.output set from storage math float_reciprocal.output
