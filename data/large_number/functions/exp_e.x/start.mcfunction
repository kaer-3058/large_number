...
#如果输入的值很小则强行展开
execute if score #is_XXEXX int matches 1 if data storage large_number:math {temp1:0} in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:exp_e.x/input_add_1
...
function large_number:exp_e.x/macro6.string_to_double with storage large_number:math double_to_int
execute store result score #temp2 int run data get storage large_number:math temp3
...
#特殊值
execute store result score #stemp1 int run data get storage large_number:math exp_e^x.input
execute if score #stemp1 int matches 710.. run data modify storage large_number:math exp_e^x.output set value 9.99999E400d
execute if score #stemp1 int matches ..-709 run data modify storage large_number:math exp_e^x.output set value 0.0d
