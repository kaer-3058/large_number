...
execute if data storage large_number:math {stemp_expression1:"τ"} run data modify storage large_number:math stemp_expression1 set string storage large_number:math expression_evaluation_variables."τ" 0 -1
