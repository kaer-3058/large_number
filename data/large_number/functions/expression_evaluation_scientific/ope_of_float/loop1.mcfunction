...
scoreboard players set #temp1 int 40
...
execute if score #temp1 int matches 40 run function large_number:expression_evaluation_scientific/ope_of_float/loop1.if
execute unless score #temp1 int matches 40 run function large_number:expression_evaluation_scientific/ope_of_float/ope
