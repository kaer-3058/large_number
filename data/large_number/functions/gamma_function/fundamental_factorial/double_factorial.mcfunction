...
execute if score #natural_num.double_factorial.inp int matches 1..3 store result storage math natural_num_double_factorial double 1 run scoreboard players get #natural_num.double_factorial.inp int
