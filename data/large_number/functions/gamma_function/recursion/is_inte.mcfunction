...
execute store result score #natural_num.factorial.input int run data get storage math gamma_function.input
...
data modify storage math gamma_function.output set from storage math natural_num_factorial
