...
#输入：data modify storage math gamma_function.input set value 73.2074d

##1.连乘

data modify storage math float_multiply.input1 set from storage math gamma_function.input
data modify storage math float_multiply.output set from storage math float_multiply.input1
execute store result score #temp1 int run data get storage math float_multiply.output
data modify storage math float_multiply.input2 set from storage math float_multiply.input1
execute if score #temp1 int matches 0 run data modify storage math float_multiply.output set from storage math gamma_function.input
execute if score #temp1 int matches 1.. run function large_number:gamma_function/recursion/loop
#-----------------------------------------#

##2.查表求前三位小数的伽玛值
execute store result score #temp1 int run data get storage math float_multiply.input1 1000
execute store result score #temp2 int run data get storage math float_multiply.input1 10000
...
execute store result storage math temp1 int 1 run scoreboard players add #temp1 int 1000
data modify storage math temp1 set string storage math temp1 -3
function large_number:gamma_function/recursion/macro2 with storage math
