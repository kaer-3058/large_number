...
#输入：data modify storage math Harmonic_series_sum_input set value 8.2184074E307d

data modify storage math ln_la_temp1 set string storage math Harmonic_series_sum_input 0 -1
...
execute store result storage math ln_la_temp5 double 2.302585092994 run scoreboard players get #ln_double.expon int
...
execute store result score #Harmonic_series.sum.output int run data get storage math ln_la_temp5 10000
