...
execute store result score #sstemp1 int run data get storage math stemp3[0]
execute store result score #sstemp2 int run data get storage math stemp3[1]
data remove storage math stemp3[0]
data remove storage math stemp3[0]
...
data modify storage math stemp3 prepend from storage math tempc
data modify storage math stemp3 prepend from storage math tempb
data modify storage math stemp3 prepend from storage math tempa
