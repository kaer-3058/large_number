...
execute store result score #1.0 int store result score #1.1 int store result score #1.2 int store result score #1.3 int run scoreboard players operation vec_.output int = #inp int
execute if score #inp int matches ..13924 run function large_number:simple_int_sqrt_range/int_3d_vector/0
execute if score #inp int matches 13925..16777216 run function large_number:simple_int_sqrt_range/int_3d_vector/1
execute if score #inp int matches 16777217.. run function large_number:simple_int_sqrt_range/int_3d_vector/2
...
scoreboard players operation vec_.output int /= 2 const
scoreboard players operation #1.2 int /= vec_.output int
scoreboard players operation vec_.output int += #1.2 int
scoreboard players operation vec_.output int /= 2 const
scoreboard players operation #1.3 int /= vec_.output int
scoreboard players operation vec_.output int += #1.3 int
