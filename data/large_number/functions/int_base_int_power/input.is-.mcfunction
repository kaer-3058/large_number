...
data modify storage math float_reciprocal.input set from storage math int_base_int_power_out

#载入除数
scoreboard players set #Divisor_float_sign int 1
data modify storage math temp1 set string storage math float_reciprocal.input 0 -1
...
function large_number:division/float_reciprocal/macro with storage math


data modify storage math int_base_int_power_out set from storage math float_reciprocal.output
