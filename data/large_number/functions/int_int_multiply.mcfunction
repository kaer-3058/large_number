...
#调整符号
execute unless score #input_-1 int = #input.2_-1 int run function large_number:multiply_unlessinput_-1iinput.2_-1_1

data modify storage math int_int_multiply.output set value [I;0,0,0,0,0]
execute store result storage math int_int_multiply.output[0] int 1.0 run scoreboard players get #4.1 int
execute store result storage math int_int_multiply.output[1] int 1.0 run scoreboard players get #4.2 int
execute store result storage math int_int_multiply.output[2] int 1.0 run scoreboard players get #4.3 int
execute store result storage math int_int_multiply.output[3] int 1.0 run scoreboard players get #4.4 int
execute store result storage math int_int_multiply.output[4] int 1.0 run scoreboard players get #4.5 int
