...
execute store result score #a int store result score #b int run scoreboard players get #c int
...
data modify storage math int_squ set value [I;0,0,0,0,0]
execute store result storage math int_squ[0] int 1.0 run scoreboard players operation #4.1 int %= 10000 const
execute store result storage math int_squ[1] int 1.0 run scoreboard players operation #4.2 int %= 10000 const
execute store result storage math int_squ[2] int 1.0 run scoreboard players operation #4.3 int %= 10000 const
execute store result storage math int_squ[3] int 1.0 run scoreboard players operation #4.4 int %= 10000 const
execute store result storage math int_squ[4] int 1.0 run scoreboard players operation #4.5 int %= 10000 const