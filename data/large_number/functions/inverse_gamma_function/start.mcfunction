...
#ln(x/√(2π))
execute in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:inverse_gamma_function/entity_pos_1
...
#W(ln(x/√(2π))/e)
data modify storage large_number:math lambertw.input set from storage large_number:math float_division.output
...
execute in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:inverse_gamma_function/entity_pos_2
