...
#输入
#最高支持24位数，但不一定非要输入满24位，兼容1~24位数
#data modify storage large_number:math large_sqrt.input set value [I;0,0,0,0,0,0]

execute store result score #11.1 int store result score #a int store result score #b int run data get storage large_number:math large_sqrt.input[-6]
execute store result score #c int store result score #d int store result score #1.2 int run data get storage large_number:math large_sqrt.input[-5]
execute store result score #e int store result score #f int run data get storage large_number:math large_sqrt.input[-4]
execute store result score #g int store result score #h int run data get storage large_number:math large_sqrt.input[-3]
execute store result score #i int store result score #j int run data get storage large_number:math large_sqrt.input[-2]
execute store result score #k int store result score #l int run data get storage large_number:math large_sqrt.input[-1]
...
data modify storage large_number:math large_sqrt.output set value [I;0,0,0]
execute store result storage large_number:math large_sqrt.output[0] int 1.0 store result score #5.1 int store result score #3.9.1 int store result score #3.8 int store result score #3.7 int store result score #3.6 int store result score #sqrt_root_X int run scoreboard players operation #9.2 int = #11.2 int
...
scoreboard players operation #sqrt_root_Y int *= 10 const
execute store result storage large_number:math large_sqrt.output[1] int 1.0 store result score #5.2 int store result score #3.9.2 int run scoreboard players operation #sqrt_root_Y int += #loop_math.1 int
...
scoreboard players operation #sqrt_root_Z int *= 10 const
execute store result storage large_number:math large_sqrt.output[2] int 1.0 run scoreboard players operation #sqrt_root_Z int += #loop_math.1 int
