...
execute store result score #11.1 int store result score #a int store result score #b int run data get storage math large_sqrt.input[-6]
execute store result score #c int store result score #d int store result score #1.2 int run data get storage math large_sqrt.input[-5]
execute store result score #e int store result score #f int run data get storage math large_sqrt.input[-4]
execute store result score #g int store result score #h int run data get storage math large_sqrt.input[-3]
execute store result score #i int store result score #j int run data get storage math large_sqrt.input[-2]
execute store result score #k int store result score #l int run data get storage math large_sqrt.input[-1]
