execute store result score #d1.1 int run data get storage large_number:math large_sqrt_digit16.input[1]
execute store result score #d1.2 int run data get storage large_number:math large_sqrt_digit16.input[2]
execute store result score #d1.3 int run data get storage large_number:math large_sqrt_digit16.input[3]
