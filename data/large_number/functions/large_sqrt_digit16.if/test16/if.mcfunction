execute store result score #digit1.3 int run data get storage math large_sqrt_digit16.input[2]
execute store result score #digit1.4 int run data get storage math large_sqrt_digit16.input[3]
