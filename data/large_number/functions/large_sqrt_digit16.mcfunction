...
execute if score #digit1.1 int matches 1000.. store result storage large_number:math large_sqrt_digit16.output int 1 run scoreboard players get #d2.1 int
...
execute if score #digit1.1 int matches 0 if score #digit1.2 int matches 1000.. store result storage large_number:math large_sqrt_digit16.output int 1 run scoreboard players operation #d2.1 int /= 100 const
execute if score #digit1.1 int matches 0 if score #digit1.2 int matches 10..999 store result storage large_number:math large_sqrt_digit16.output int 1 run scoreboard players operation #d2.1 int /= 1000 const
