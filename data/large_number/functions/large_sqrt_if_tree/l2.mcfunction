scoreboard players operation #Iteration_2.0 int = #3.12.0 int
scoreboard players operation #Iteration_2.1 int = #3.12.1 int
scoreboard players operation #Iteration_2.2 int = #3.12.2 int
scoreboard players operation #Iteration_2.3 int = #3.12.3 int
...
execute if score #Iteration_>#2._ int matches 1 run function large_number:if_iteration_3_2.2_/l/3
...
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int if score #Iteration_2.2 int > #2.12.2 int run scoreboard players set #Iteration_>#2._ int 1
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int unless score #Iteration_2.2 int < #2.12.2 int if score #Iteration_2.3 int > #2.12.3 int run scoreboard players set #Iteration_>#2._ int 1
execute if score #Iteration_>#2._ int matches 1 run function large_number:if_iteration_3_2.2_/l/2
...
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int if score #Iteration_2.2 int > #2.12.2 int run scoreboard players set #Iteration_>#2._ int 1
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int unless score #Iteration_2.2 int < #2.12.2 int if score #Iteration_2.3 int > #2.12.3 int run scoreboard players set #Iteration_>#2._ int 1
execute if score #Iteration_>#2._ int matches 1 run function large_number:if_iteration_3_2.2_/l/1
...
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int if score #Iteration_2.2 int > #2.12.2 int run scoreboard players set #Iteration_>#2._ int 1
execute unless score #Iteration_2.0 int < #2.12.0 int unless score #Iteration_2.1 int < #2.12.1 int unless score #Iteration_2.2 int < #2.12.2 int if score #Iteration_2.3 int > #2.12.3 int run scoreboard players set #Iteration_>#2._ int 1
execute if score #Iteration_>#2._ int matches 1 run function large_number:if_iteration_3_2.2_/l/0