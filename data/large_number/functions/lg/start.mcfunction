...
execute store result storage math lg(x)_output double 0.4342944819033 run scoreboard players get #loga.b.output int
execute store result score #lg(x)_output int run data get storage math lg(x)_output
...
execute store result storage math lg(x)_output double 0.0001 run scoreboard players get #lg(x)_output int
