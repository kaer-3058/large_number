...
execute store result score #E int store result score #z int store result score #5 int run scoreboard players set #e int 5910
execute store result score #D int store result score #y int store result score #4 int run scoreboard players set #d int 1658
execute store result score #C int store result score #x int store result score #3 int run scoreboard players set #c int 6051
execute store result score #B int store result score #v int store result score #2 int run scoreboard players set #b int 8198
execute store result score #A int store result score #u int store result score #1 int run scoreboard players set #a int 1479
