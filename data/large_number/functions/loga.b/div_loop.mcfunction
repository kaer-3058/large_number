...
#载入被除数
execute store result score #temp2 int run scoreboard players operation #temp1 int = #store_#loga.b.tempinp int
...
execute if score #temp5 int matches 10001.. run function large_number:loga.b/div_loop
