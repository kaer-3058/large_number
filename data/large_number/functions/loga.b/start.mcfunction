...
execute store result storage large_number:math "log.a(b).output" double 0.0001 run scoreboard players operation #loga.b.ln(b) int += #temp2 int
...
execute unless data storage large_number:math "log.a(b).output" run scoreboard players reset #loga.b.output int
data modify storage large_number:math temp1 set string storage large_number:math "log.a(b).output" 0 -1
