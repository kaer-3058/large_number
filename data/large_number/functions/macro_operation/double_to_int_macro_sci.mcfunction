...
#从后往前逐位读取到计分板，自动靠后对齐
execute store result storage large_number:math temp7 int 0 store result storage large_number:math temp8 int 0 store result storage large_number:math temp9 int 0 run data modify storage large_number:math temp6 set value 0
...
#最终赋值
function large_number:macro_operation/double_ope_macro2_sci with storage large_number:math
