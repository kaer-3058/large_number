#输入
#execute store result entity b09e-44-fded-6-efa5ffffef64 Rotation[0] float 0.0057295779513082320876798154814105 run data get storage math math_trifs.input 10000.0
