...
#输入：data modify storage math double_sqrt.input set value 0.0d
...
data modify storage math double_sqrt.output set value {double_sci:0.0d}
...
function large_number:new_double_ope/macro1.cut_math with storage math

#double取为int
execute store result score #store_ds_inp int store result score #double_sqrt.int_inp int run data get storage math temp2
execute if score #double_sqrt.int_inp int matches 0..9 store result score #double_sqrt.int_inp int run data get storage math temp2 100000000
execute if score #double_sqrt.int_inp int matches 10..999 store result score #double_sqrt.int_inp int run data get storage math temp2 1000000
execute if score #double_sqrt.int_inp int matches 1000..99999 store result score #double_sqrt.int_inp int run data get storage math temp2 10000
execute if score #double_sqrt.int_inp int matches 100000..9999999 store result score #double_sqrt.int_inp int run data get storage math temp2 100
execute store result score #stemp5 int run data get storage math temp2 10
execute if score #stemp5 int matches 0 store result score #double_sqrt.int_inp int run data get storage math temp2 10000000000
scoreboard players operation #stemp1 int = #double.expon int
scoreboard players operation #stemp1 int %= 2 const
execute if score #is_XXEXX int matches 1 if score #stemp1 int matches 1 store result score #double_sqrt.int_inp int run data get storage math temp2 10000000
...
execute store result storage math temp_expon int 1 run scoreboard players get #double.expon int

#根据输入的double整数部分的位数调整结果
execute store result storage math temp1 double 1 run scoreboard players get #double_sqrt.int_output int
execute if score #store_ds_inp int matches 0..9 store result storage math temp1 double 0.00000001 run scoreboard players get #double_sqrt.int_output int
execute if score #store_ds_inp int matches 10..999 store result storage math temp1 double 0.0000001 run scoreboard players get #double_sqrt.int_output int
execute if score #store_ds_inp int matches 1000..99999 store result storage math temp1 double 0.000001 run scoreboard players get #double_sqrt.int_output int
execute if score #store_ds_inp int matches 100000..9999999 store result storage math temp1 double 0.00001 run scoreboard players get #double_sqrt.int_output int
execute if score #stemp5 int matches 0 store result storage math temp1 double 0.000000001 run scoreboard players get #double_sqrt.int_output int
execute if score #is_XXEXX int matches 1 if score #stemp1 int matches 1 store result storage math temp1 double 0.0000001 run scoreboard players get #double_sqrt.int_output int

#最终输出
data modify storage math temp1 set string storage math temp1 0 -1
function large_number:new_double_ope/macro2.output with storage math
