...
data modify storage math parabola_expre_x set value []
data modify storage math parabola_expre_y set value []
...
tellraw @a {"text":"\u00A77抛物线解析完成"}

#知道什么比魔法更酷吗？是数学！ ——《蜘蛛侠·英雄无归》


#tellraw @a ["f(x)=",{"nbt":"parabola_tellraw.a","storage":"math"},"x²",{"nbt":"parabola_tellraw.1","storage":"math"},{"nbt":"parabola_tellraw.b","storage":"math"},"x",{"nbt":"parabola_tellraw.2","storage":"math"},{"nbt":"parabola_tellraw.c","storage":"math"}]

#data modify entity @e[tag=display,limit=1] text set value '["f(x)=",{"nbt":"parabola_tellraw.a","storage":"math"},"x²",{"nbt":"parabola_tellraw.1","storage":"math"},{"nbt":"parabola_tellraw.b","storage":"math"},"x",{"nbt":"parabola_tellraw.2","storage":"math"},{"nbt":"parabola_tellraw.c","storage":"math"}]'
