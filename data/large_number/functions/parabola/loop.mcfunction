...
execute store result storage math stemp1 double 0.01 run scoreboard players operation #parabola_mathstep int += #parabola_expre_x.step_size int
data modify storage math parabola_expre_x append from storage math stemp1
...
#调整符号
data modify storage math stemp10 set value ""
execute unless score #input_-1 int = #input.2_-1 int run data modify storage math stemp10 set value "-"

execute store result storage math stemp1 int 1.0 run scoreboard players add #4.1 int 10000
execute store result storage math stemp2 int 1.0 run scoreboard players add #4.2 int 10000
execute store result storage math stemp3 int 1.0 run scoreboard players add #4.3 int 10000
execute store result storage math stemp4 int 1.0 run scoreboard players add #4.4 int 10000
execute store result storage math stemp6 int 1.0 run scoreboard players add #4.5 int 10000

data modify storage math stemp1 set string storage math stemp1 1
data modify storage math stemp2 set string storage math stemp2 1
data modify storage math stemp3 set string storage math stemp3 1
data modify storage math stemp5 set string storage math stemp4 -1
data modify storage math stemp4 set string storage math stemp4 1 -1
data modify storage math stemp6 set string storage math stemp6 1
###########################################
function large_number:parabola/macro1 with storage math

#ax+b
execute in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:parabola/macro2 with storage math

#(ax+b)*x
function large_number:parabola/macro3 with storage math
...
function large_number:parabola/macro7 with storage math
execute store result storage math temp_expon int 1 run scoreboard players remove #temp_expon int 2
function large_number:parabola/macro8 with storage math

#(ax+b)*x+c
execute in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:parabola/macro4 with storage math

execute unless score #store_parabola_expre_y int matches ..2147483647 store result score #store_parabola_expre_y int run data get storage math parabola_expre_y[0] 100
execute store result score #temp2 int run data get storage math parabola_expre_y[-1] 100
execute store result storage math parabola_expre_y[-1] double 0.01 run scoreboard players operation #temp2 int -= #store_parabola_expre_y int
