...
function large_number:particle/3d_hsphere/particle/macro1 with storage large_number:math

data remove storage large_number:math temp1[0]
execute if data storage large_number:math temp1[0] run function large_number:particle/3d_hsphere/particle/loop
