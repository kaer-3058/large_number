...
execute store result storage large_number:math temp1 double 0.00001 run scoreboard players operation #temp_r int += #temp int
execute store result storage large_number:math temp2 double 0.01 run scoreboard players get #store_startθ int
execute in minecraft:overworld as b09e-44-fded-6-efa5ffffef64 run function large_number:particle/archimedean_spiral/macro1 with storage large_number:math
