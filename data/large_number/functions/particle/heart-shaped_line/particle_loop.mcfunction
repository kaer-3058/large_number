...
function large_number:particle/heart-shaped_line/particle.macro1 with storage large_number:math

data remove storage large_number:math temp1[0]
execute if data storage large_number:math temp1[0] run function large_number:particle/heart-shaped_line/particle_loop
