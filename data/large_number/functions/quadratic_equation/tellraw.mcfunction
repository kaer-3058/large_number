...
data modify storage math quadratic_equation_out_json_tellraw.json1 set value '["方程: \\"",{"score":{"name":"#X_squ_equ.a","objective":"int"}},"x^2 ",{"nbt":"quadratic_equation_out_json_tellraw.b","storage":"math"},{"score":{"name":"#X_squ_equ.b","objective":"int"}},"x ",{"nbt":"quadratic_equation_out_json_tellraw.c","storage":"math"},{"score":{"name":"#X_squ_equ.c","objective":"int"}}," =0\\", "]'
...
execute if score #X_squ_equ.roots int matches 2 run data modify storage math quadratic_equation_out_json_tellraw.json2 set value '["解得: ","x1= ",{"nbt":"quadratic_equation_out_json_tellraw.x1","storage":"math"},", x2= ",{"nbt":"quadratic_equation_out_json_tellraw.x2","storage":"math"}]'
