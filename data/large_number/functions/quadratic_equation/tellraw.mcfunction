...
data modify storage large_number:math quadratic_equation_out_json_tellraw.json1 set value '["方程: \\"",{"score":{"name":"#X_squ_equ.a","objective":"int"}},"x²",{"nbt":"quadratic_equation_out_json_tellraw.b","storage":"large_number:math"},{"score":{"name":"#X_squ_equ.b","objective":"int"}},"x",{"nbt":"quadratic_equation_out_json_tellraw.c","storage":"large_number:math"},{"score":{"name":"#X_squ_equ.c","objective":"int"}},"=0\\", "]'
...
execute if score #X_squ_equ.roots int matches 2 run data modify storage large_number:math quadratic_equation_out_json_tellraw.json2 set value '["解得: ","x₁=",{"nbt":"quadratic_equation_out_json_tellraw.x1","storage":"large_number:math"},", x₂=",{"nbt":"quadratic_equation_out_json_tellraw.x2","storage":"large_number:math"}]'
...
execute if score #X_squ_equ.roots int matches 1 run data modify storage large_number:math quadratic_equation_out_json_tellraw.json2 set value '["解得: ","x=",{"nbt":"quadratic_equation_out_json_tellraw.x1","storage":"large_number:math"}]'
execute if score #X_squ_equ.roots int matches 0 run data modify storage large_number:math quadratic_equation_out_json_tellraw.json2 set value '{"text":"解得: 无实数根"}'
