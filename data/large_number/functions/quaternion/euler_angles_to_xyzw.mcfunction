...
#输入：data modify storage math euler_angles_input set value [0.0,0.0,0.0]
#输出：data get storage math xyzw

#角度/2 + 获取对应的cos，sin (世界实体)
execute store result score #euler_angles.x int run data get storage math euler_angles_input[0] 1000
execute store result score #euler_angles.y int run data get storage math euler_angles_input[1] 1000
execute store result score #euler_angles.z int run data get storage math euler_angles_input[2] 1000
...
execute store result storage math xyzw[3] float 0.000000001 run scoreboard players operation #euler_angles.q int += #euler_angles.q_ int
...
scoreboard players operation #euler_angles.q_ int *= #euler_angles.y.sin int
scoreboard players operation #euler_angles.q_ int *= #euler_angles.z.sin int
execute store result storage math xyzw[2] float -0.000000001 run scoreboard players operation #euler_angles.q int -= #euler_angles.q_ int
...
scoreboard players operation #euler_angles.q_ int *= #euler_angles.z.sin int
execute store result storage math xyzw[0] float -0.000000001 run scoreboard players operation #euler_angles.q int += #euler_angles.q_ int
...
execute store result storage math xyzw[1] float 0.000000001 run scoreboard players operation #euler_angles.q int -= #euler_angles.q_ int
