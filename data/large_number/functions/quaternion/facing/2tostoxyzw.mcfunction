...
execute store result storage math quaternion.xyzw[0] float 0.00000001 run scoreboard players operation #qrot_x int *= #sstemp_c1 int
execute store result storage math quaternion.xyzw[1] float -0.00000001 run scoreboard players operation #qrot_y int *= #sstemp_s1 int
execute store result storage math quaternion.xyzw[2] float 0.00000001 run scoreboard players operation #qrot_z int *= #sstemp_s1 int
execute store result storage math quaternion.xyzw[3] float 0.00000001 run scoreboard players operation #qrot_w int *= #sstemp_c1 int
