function large_number:sigmoid/macro5 with storage large_number:math
...
execute as b09e-44-fded-6-efa5ffffef64 run function large_number:sigmoid/as_entity_2
