function large_number:sigmoid/macro6 with storage large_number:math
...
execute store result storage large_number:math temp_expon int 1 run scoreboard players remove #_exp int 2
function large_number:sigmoid/macro4 with storage large_number:math

execute as b09e-44-fded-6-efa5ffffef64 run function large_number:sigmoid/as_entity_3
