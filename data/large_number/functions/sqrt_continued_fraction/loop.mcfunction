...
execute if score #temp.e int matches 0 if score #conti_frac.sqrt.reduction_fraction int matches 1 unless score #temp.b int = #temp.a int run function large_number:sqrt_continued_fraction/loop.reduction_fraction
