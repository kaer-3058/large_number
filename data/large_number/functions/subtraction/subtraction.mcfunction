...
execute store success storage math subtraction.output[0] int 0.0 store result storage math subtraction.output[1] int 1.0 run scoreboard players get #1.1 int
