...
execute store result score #8.3 int store result score #8.4 int store result score #8.5 int store result score #1.0 int store result score #1.1 int run scoreboard players operation output.sqrt int = #inp int
