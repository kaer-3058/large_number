...
execute store result score #8.3 int store result score #8.4 int store result score #8.5 int store result score #1.0 int store result score #1.1 int store result score #1.2 int store result score #1.3 int run scoreboard players operation output.sqrt int = #inp int
execute if score #inp int matches ..13924 run function large_number:simple_int_sqrt_range/0
execute if score #inp int matches 13925..16777216 run function large_number:simple_int_sqrt_range/1
execute if score #inp int matches 16777217.. run function large_number:simple_int_sqrt_range/2
...
execute store result score #9.1 int store result score #8.7 int store result score #8.1 int store result score #7.1 int store result score #6.5 int store result score #6.3 int store result score #6.2 int run scoreboard players get output.sqrt int
...
execute if score input.sqrt int matches 1..9 run function large_number:int_sqrt_scb_tree/1-9
execute if score input.sqrt int matches 10..999 run function large_number:int_sqrt_scb_tree/10-999
execute if score input.sqrt int matches 1000..99999 run function large_number:int_sqrt_scb_tree/1000-99999
execute if score input.sqrt int matches 100000..9999999 run function large_number:int_sqrt_scb_tree/100000-9999999
execute if score input.sqrt int matches 10..9999999 store result score output.dicimal int run scoreboard players operation #6.5 int += #6.1 int
