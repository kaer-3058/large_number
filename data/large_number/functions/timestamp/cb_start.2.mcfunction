...
data modify storage math temp1 set string storage timestamp output_base64_json.timestamp 0 -3
#data modify storage math temp1 set value 1703778042
function large_number:timestamp/macro.6.string_ro_int with storage math
...
#用命令方块获取时分秒
execute in minecraft:overworld run data modify storage math temp1 set string block -29999984 -60 22022222 LastOutput 10 18
data modify storage timestamp output_day_Second set string storage math temp1 6 8
data modify storage timestamp output_day_Minute set string storage math temp1 3 5
data modify storage timestamp output_day_Hour set string storage math temp1 0 2

function large_number:timestamp/macro.7.get_cb_output_time with storage timestamp
