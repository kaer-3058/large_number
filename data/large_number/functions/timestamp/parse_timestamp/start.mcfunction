...
#输入：data modify storage large_number:math parse_timestamp.input set value ""

data modify storage large_number:math temp1 set from storage large_number:math parse_timestamp.input
function large_number:timestamp/parse_timestamp/macro.string_ro_int with storage large_number:math
...
execute if score #GMT-time_zone int matches ..-1 run data modify storage large_number:math parse_timestamp.GMT+- set value ""


execute unless score #GMT-time_zone int matches 8 run data modify storage large_number:math parse_timestamp.tellraw set value '[{"text":"解析结果：GMT"},{"nbt":"parse_timestamp.GMT+-","storage":"large_number:math"},{"score":{"name":"#GMT-time_zone","objective":"int"}},{"text":" "},{"score":{"name":"#parse_timestamp.year","objective":"int"}},{"text":"年"},{"score":{"name":"#parse_timestamp.month","objective":"int"}},{"text":"月"},{"score":{"name":"#parse_timestamp.day","objective":"int"}},{"text":"日，"},{"score":{"name":"#parse_timestamp.Hour","objective":"int"}},{"text":"时"},{"score":{"name":"#parse_timestamp.Minute","objective":"int"}},{"text":"分"},{"score":{"name":"#parse_timestamp.Second","objective":"int"}},{"text":"秒"}]'
execute if score #GMT-time_zone int matches 8 run data modify storage large_number:math parse_timestamp.tellraw set value '[{"text":"解析结果：北京时间(GMT+8) "},{"score":{"name":"#parse_timestamp.year","objective":"int"}},{"text":"年"},{"score":{"name":"#parse_timestamp.month","objective":"int"}},{"text":"月"},{"score":{"name":"#parse_timestamp.day","objective":"int"}},{"text":"日，"},{"score":{"name":"#parse_timestamp.Hour","objective":"int"}},{"text":"时"},{"score":{"name":"#parse_timestamp.Minute","objective":"int"}},{"text":"分"},{"score":{"name":"#parse_timestamp.Second","objective":"int"}},{"text":"秒"}]'
