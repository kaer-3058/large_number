...
execute store result storage math temp_vec_modulus[0] double 0.0001 run scoreboard players operation #v2.x int -= #v1.x int
execute store result storage math temp_vec_modulus[1] double 0.0001 run scoreboard players operation #v2.y int -= #v1.y int
execute store result storage math temp_vec_modulus[2] double 0.0001 run scoreboard players operation #v2.z int -= #v1.z int
