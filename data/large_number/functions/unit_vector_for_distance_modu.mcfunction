...
execute store result storage math buffer_all_xyz[0] double 0.0001 store result score #v.x int run data get storage math unit_vector_modu.input[0] 100.0
execute store result storage math buffer_all_xyz[1] double 0.0001 store result score #v.y int run data get storage math unit_vector_modu.input[1] 100.0
execute store result storage math buffer_all_xyz[2] double 0.0001 store result score #v.z int run data get storage math unit_vector_modu.input[2] 100.0
