...
execute store result score #x int run data get storage math temp1[0] 10000
execute store result score #y int run data get storage math temp1[1] 10000
execute store result score #z int run data get storage math temp1[2] 10000
...
execute positioned 0.0 0.0 0.0 run tp @s ^ ^1 ^
data modify storage math temp1 set from entity @s Pos
execute store result score #j.x int run data get storage math temp1[0] 10000
...
execute positioned 0.0 0.0 0.0 run tp @s ^ ^ ^1
data modify storage math temp1 set from entity @s Pos
execute store result score #k.x int run data get storage math temp1[0] 10000
