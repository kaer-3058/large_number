...
#整合
data modify storage math xp.output set value [I;0,0,0,0,0]
execute store result storage math xp.output[0] int 1 run scoreboard players operation #4.1 int += #5.1 int
execute store result storage math xp.output[1] int 1 run scoreboard players operation #4.2 int %= 10000 const
execute store result storage math xp.output[2] int 1 run scoreboard players operation #4.3 int %= 10000 const
execute store result storage math xp.output[3] int 1 run scoreboard players operation #4.4 int %= 10000 const
execute store result storage math xp.output[4] int 1 run scoreboard players operation #4.5 int %= 10000 const
