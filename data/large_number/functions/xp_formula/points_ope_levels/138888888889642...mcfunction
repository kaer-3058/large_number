...
#输入
#data modify storage math large_sqrt.input set value [I;0,0,0,0,0,0]
...
#加法 +307
execute store result score #5.4 int run scoreboard players add #xp_2.large_sqrt[2] int 307
scoreboard players operation #5.4 int /= 10000 const
...
execute store result storage math xp_points_ope_levels.output_levels int 1 run scoreboard players operation #xp_2.out_level int += #temp3 int
...
execute store result storage math xp_points_ope_levels.remaining_points[0] int 1 run scoreboard players get #xp_2.input[0] int
execute store result storage math xp_points_ope_levels.remaining_points[1] int 1 run scoreboard players get #xp_2.input[1] int
execute store result storage math xp_points_ope_levels.remaining_points[2] int 1 run scoreboard players get #xp_2.input[2] int
