...
#输入：data modify storage math xp_points_ope_levels.input set value [I;0,0,0,0,0]

execute store result score #xp_2.input[0] int run data get storage math xp_points_ope_levels.input[-5]
execute store result score #xp_2.input[1] int run data get storage math xp_points_ope_levels.input[-4]
execute store result score #xp_2.input[2] int run data get storage math xp_points_ope_levels.input[-3]
...
# 0..351
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 0 if score #storeT_xp_2.input[4] int matches 0..351 store result storage math xp_points_ope_levels.output_levels int 1 run function large_number:xp_formula/points_ope_levels/0..351

# 352..1757
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 0 if score #storeT_xp_2.input[4] int matches 352..1757 store result storage math xp_points_ope_levels.output_levels int 1 run function large_number:xp_formula/points_ope_levels/352..1757
...
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 2982 if score #storeT_xp_2.input[4] int matches ..6914 run scoreboard players set #mode int 1

# 2982,6915..138,8888,8888,9641
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 0 if score #storeT_xp_2.input[2] int matches 0 if score #storeT_xp_2.input[3] int matches 2982 if score #storeT_xp_2.input[4] int matches 6915.. run scoreboard players set #mode int 2
...
execute if score #storeT_xp_2.input[0] int matches 0 if score #storeT_xp_2.input[1] int matches 138 if score #storeT_xp_2.input[2] int matches 8888 if score #storeT_xp_2.input[3] int matches 8888 if score #storeT_xp_2.input[4] int matches ..9641 run scoreboard players set #mode int 2
...
execute if score #mode int matches 1 run function large_number:xp_formula/points_ope_levels/1758..29826914
execute if score #mode int matches 2 run function large_number:xp_formula/points_ope_levels/29826915..138888888889641
execute if score #mode int matches 3 run function large_number:xp_formula/points_ope_levels/138888888889642..
